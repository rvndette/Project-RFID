<x-filament-panels::page>
    <div class="space-y-4">
        <h2 class="text-xl font-bold">Data Kelas Praktikan: {{ $praktikan->nama }}</h2>
        ...
        <a href="{{ route('filament.admin.resources.praktikans.index') }}" class="text-primary-600 hover:underline">
            ← Kembali ke Data Praktikan
        </a>
    </div>
</x-filament-panels::page>
